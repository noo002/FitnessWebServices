...
<html>
    ...
    <body>
        ...
        ?>
        <p>
            <b><a href="../../../Control/Trainer/activityList.php">Activity List </a> - New Activity Registration </b>
        </p><br/>
        <div>
            <form action="../../../Control/Trainer/newActivity.php" method="post" enctype="multipart/form-data">
