...
<html>
    ...
    <body>
        ...
        ?>
        <p>
            <b><a href="../../../Control/Trainer/activityList.php">Activity List</a> - Edit Activity </b>

        </p>
        <br/>
        <form method="post" action="../../../Control/Trainer/editActivity.php" enctype="multipart/form-data">
