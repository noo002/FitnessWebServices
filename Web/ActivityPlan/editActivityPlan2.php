<div class="modal" id="editPlanModal2" role="dialog">
    <div class="modal-dialog" style="width:80%; height:100%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form onSubmit="return updatePlan()">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = $result->fetch_Array()) {
                                    ...
                                    echo '<td><input id="chk'.$row[0].'" value="'.$row[0].'" type="checkbox"/></td>';
                                    if($row[5]!='') {
                                    ...
                                    echo '<td>'.$row[1].'</td>';
                                    echo '<td id="editCal">'.$row[3].'</td>';
                                    echo '<td><input type="number" id="editTime" min="1" required class="form-control" disabled/></td>';
                                    echo '<td id="editSubCal">0</td>';
                                    echo '</tr>';
                                }
                    ...
                    <br/>
                    <button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-pencil"></span> Add</button>
                </form>
            </div>
        </div>
    </div>
