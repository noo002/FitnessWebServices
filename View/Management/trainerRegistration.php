...
<html>
    ...
    <script>
        document.getElementById('pathLocation').innerHTML = "Trainer List - New Trainer Registration";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="content">
                            <div class="">
                                <form method="POST" action="../../Control/Management/trainerRegistration.php">
                                    <table class="table table-bordered table-striped" align="center">
                                        <thead>
                                            <tr>
                                                <th colspan="2" style="text-align: center;color:black">New Trainer Registration</th>
                                            </tr>
                                        </thead>
                                        <tr>
                                            <td><b>Name : </b></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="2"class="alert alert-info">
                                                    <strong>
                                                        <ul>
                                                            <li>Password will be send through registered email.</li>
