<div class="modal" id="newPlanModal" role="dialog">
    <div class="modal-dialog" style="width:80%; height:100%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form onSubmit="return addNewPlan()">
                    <div class="form-group">
                        <label for="planName">Activity Plan Name</label>
                        <input type="text" id="newName" maxlength="255" class="form-control" placeholder="Enter activity plan name" required/>
                    </div>
                    <table id="myTable2">
                        <thead>
                            <tr>
